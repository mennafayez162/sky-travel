                ...
                <div className="text-center mb-6">
                  <div className="relative w-24 h-24 mx-auto mb-4 group">
                    ...
                    <button
                      ...
                      className="absolute inset-0 rounded-full bg-black/50 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity flex items-center justify-center"
                    >
                      {isUploading ? (
