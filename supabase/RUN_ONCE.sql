...
-- It disables RLS on ALL tables so the app can work
-- ============================================
...
-- Add currency columns to settings
...
-- Add bilingual columns to settings
...
-- Add bilingual columns to trips
...
-- Add bilingual columns to destinations
...
-- Add bilingual columns to blogs
...
SELECT 'Done! RLS disabled + all columns added.' as result;
